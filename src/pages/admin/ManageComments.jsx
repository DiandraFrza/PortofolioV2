...
import { FiTrash2, FiMessageCircle, FiEdit2, FiCheck, FiX } from "react-icons/fi";
      ...
      <div className="neo-card p-6 rounded-xl">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {comments.map((c) => (
              <div key={c.id} className="neo-card-purple p-4 rounded-xl flex gap-4 bg-zinc-50 dark:bg-zinc-800/50">
                  ...
                  <div className="flex justify-between items-start mb-1">
                    <div>
                      ...
                      <span className="text-[10px] font-bold text-zinc-500">
                        {c.createdAt ? new Date(c.createdAt).toLocaleString('id-ID') : 'Baru saja'}
                      </span>
                    </div>
                  ...
                  {editingId === c.id ? (
                    <div className="mt-2">
                      <textarea 
                        ...
                        className="w-full neo-input rounded-lg p-2 text-sm resize-none font-bold"
                        rows="3"
                      />
                    </div>
                  ) : (
